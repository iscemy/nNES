...
int load_nes2(char *filepath){
    ...
    prg_rom_size = file_header->prg_rom_size_l + (file_header->prg_chr_rom_size_h&0x0F)<<8;
    chr_rom_size = file_header->chr_rom_size_l + (file_header->prg_chr_rom_size_h&0xF0)<<4;
